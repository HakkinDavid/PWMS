...
class AuditRuleHelper {
  ...
  static AuditCardData forEntity({
    ...
    AuditCategory category = AuditCategory.integrity,
    ...
    return AuditCardData(
      ...
      subspecies: subspecies,
      tile: tile,
      tileBuilder: tileBuilder ?? (tile == null ? (ctx) => InstancePreviewCard(entity: entity) : null),
  ...
  static AuditCardData forSpecies({
    ...
    return AuditCardData(
      ...
      species: species,
      tile: tile,
      tileBuilder: tileBuilder ?? (tile == null ? (ctx) => SpeciesTile(species: species) : null),
      confirmLabel: confirmLabel,
      fixLabel: fixLabel,
      confirmIcon: confirmIcon,
      fixIcon: fixIcon,
  ...
  static AuditCardData forSubspecies({
    ...
    return AuditCardData(
      ...
      species: species,
      tile: tile,
      tileBuilder: tileBuilder ?? (tile == null ? (ctx) => SubspeciesTile(subspecies: subspecies, speciesName: speciesName ?? species?.name) : null),
      confirmLabel: confirmLabel,
      fixLabel: fixLabel,
      confirmIcon: confirmIcon,
      fixIcon: fixIcon,
