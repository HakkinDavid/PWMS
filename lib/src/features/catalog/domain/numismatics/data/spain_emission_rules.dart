    ...
    pieces: [
      ...
      NumismaticPieceDefinition(
        ...
        motifs: [
          ...
          NumismaticMotifRule('País Vasco (1994)', 1994, 1994),
          NumismaticMotifRule('Canarias (1995)', 1995, 1995),
          NumismaticMotifRule('Principado de Asturias (1996)', 1996, 1996),
          NumismaticMotifRule('Castilla-La Mancha (1997)', 1997, 1997),
          NumismaticMotifRule('Melilla (1997)', 1997, 1997),
          NumismaticMotifRule('Ceuta (1998)', 1998, 1998),
          NumismaticMotifRule('Comunidad Foral de Navarra (1999)', 1999, 1999),
          NumismaticMotifRule('Palacio Real de Madrid (2000)', 2000, 2000),
        ],
      ),
      NumismaticPieceDefinition(
        denomination: '50',
      ...
      NumismaticPieceDefinition(
        ...
        maxYear: 2001,
        motifs: [
          NumismaticMotifRule('Asamblea del FMI y Banco Mundial - Madrid (1994)', 1994, 1994),
          NumismaticMotifRule('Presidencia Española del Consejo de la Unión Europea (1995)', 1995, 1995),
          NumismaticMotifRule('IV Centenario de Don Quijote y Sancho (1996)', 1996, 1996),
          NumismaticMotifRule('400 Aniversario de Juan de Herrera (1997)', 1997, 1997),
          NumismaticMotifRule('IV Centenario de la Muerte de Felipe II (1998)', 1998, 1998),
          NumismaticMotifRule('Año Santo Xacobeo (1999)', 1999, 1999),
          NumismaticMotifRule('V Centenario del Nacimiento de Carlos V (2000)', 2000, 2000),
          NumismaticMotifRule('Última Emisión de la Peseta - Hispania (2001)', 2001, 2001),
        ],
      ),
    ],
  ),
    ...
    pieces: [
      ...
      NumismaticPieceDefinition(
        ...
        motifs: [
          ...
          NumismaticMotifRule('10 Años de los Billetes y Monedas en Euros (2012)', 2012, 2012),
          ...
          NumismaticMotifRule('Proclamación de Su Majestad el Rey Felipe VI (2014)', 2014, 2014),
          NumismaticMotifRule('Cueva de Altamira y Arte Rupestre del Norte de España (UNESCO 2015)', 2015, 2015),
          NumismaticMotifRule('30 Años de la Bandera de la Unión Europea (2015)', 2015, 2015),
          ...
          NumismaticMotifRule('50 Aniversario del Nacimiento del Rey Felipe VI (2018)', 2018, 2018),
          ...
          NumismaticMotifRule('V Centenario de la Vuelta al Mundo de Juan Sebastián Elcano (2022)', 2022, 2022),
          NumismaticMotifRule('35 Años del Programa Erasmus (2022)', 2022, 2022),
          NumismaticMotifRule('Ciudad Vieja de Cáceres (UNESCO 2023)', 2023, 2023),
          NumismaticMotifRule('Presidencia Española del Consejo de la Unión Europea (2023)', 2023, 2023),
          NumismaticMotifRule('Catedral, Alcázar y Archivo de Indias de Sevilla (UNESCO 2024)', 2024, 2024),
          NumismaticMotifRule('Bicentenario de la Policía Nacional (2024)', 2024, 2024),
