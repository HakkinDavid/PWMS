...
class NumismaticDataHelper {
  ...
  /// Mapping of Country / Issuer to list of associated ISO currency codes.
  ...
  /// Returns list of ISO currency codes matching the given country.
  /// If country is null, empty or 'Otro', returns all currencies.
  ...
  /// Returns a Map of ISO code to display name for the given country.
  /// If country is null, empty or 'Otro', returns all currency entries.
