...
class AppStrings {
  ...
  static const deletePropertyFromInstanceTooltip =
      'Eliminar propiedad de esta instancia.';
  ...
  static const confirmDeletePhotoMessage =
      '¿Deseas eliminar la imagen principal? Se eliminará el archivo asociado.';
  ...
  static const singleInstanceError =
      'Esta especie es única y ya existe en el mundo.';
  static const singleInstanceSubspeciesError =
      'La subespecie de esta especie única ya existe en el mundo.';
  static const duplicateSpeciesNameError =
      'Ya existe una especie con este nombre.';
  static const duplicatePhotoError =
      'Ya existe una especie con esta misma imagen.';
  static const duplicateAttachmentError =
      'Este archivo adjunto ya existe en la especie.';
  ...
  static const registeredPropertiesAndMagnitudes =
  ...
  static const speciesInstantiatedSuccess =
      'Especie instanciada correctamente.';
  static const selectSpeciesToInstantiate =
      'Selecciona una especie para instanciar.';
  static const instantiateCatalogSpeciesHeader =
      'Instanciar especie del catálogo';
  ...
  static const noContainerObjectsAvailable =
      'No hay objetos contenedores disponibles.';
  ...
  static String noContainersFoundForQuery(String query) =>
      'No se encontraron contenedores para "$query".';
  ...
  static const noAdditionalUnitsAdded =
      'No se han agregado unidades adicionales.';
  ...
  static const cannotDeleteOnlySubspecies =
      'No se puede eliminar la única subespecie de una especie.';
  static const cannotDeleteOnlySubspeciesTooltip =
      'No se puede eliminar la única subespecie.';
  ...
  static const locationHasNoObjectsOrSublocations =
      'Esta ubicación está vacía.';
  static const containerLabel = 'Contenedor';
  static const cannotMoveLocationSelfError =
  ...
  static const selectNewLocationOrContainer =
      'Selecciona la nueva ubicación o contenedor:';
  ...
  static const deleteConfirmationMessage =
      '¿Deseas eliminar este elemento del mundo?';
  static const convertToContainerTitle = '¿Convertir en contenedor?';
  static String convertToContainerMessage(String name, int count) => count == 1
  ...
  static String moveToWorldConfirmationMessage(int count) => count == 1
  ...
  static const zeroQuantityMessage =
      'La magnitud llegó a cero. ¿Deseas eliminar la instancia?';
  static const mustProvideEntityOrGroup =
      'Debe proporcionarse una entidad o grupo.';
  ...
  static const fileNotFoundInStorage =
      'Archivo no encontrado en el almacenamiento local.';
  ...
  static const noCatalogSpeciesForRequirement =
      'No hay especies disponibles en el catálogo para requerir.';
  static const selectRequiredSpeciesPrompt =
      'Selecciona la especie requerida e indica la cantidad:';
  ...
  static const noCustomAttributesDefined =
      'No hay atributos personalizados definidos.';
  ...
  static const templateUnitsHintLabel =
      'Unidades habituales separadas por coma';
  ...
  static const populationManagementInstruction =
      'Ajusta la población con los botones o ingresando la cifra directamente.';
  static const populationLabel = 'Población';
  static const groupInstanceDetail = 'Detalle de instancias en grupo';
  static const noInstancesAvailableToDelete =
      'No hay instancias disponibles para eliminar.';
  ...
  static const noInstancesToDelete =
      'No hay instancias disponibles para eliminar.';
  ...
  static const selectDirectedRelationTypePrompt =
      'Seleccionar tipo de relación dirigida';
  ...
  static const noEntitiesAvailableToRelate =
      'No hay entidades disponibles para relacionar.';
  static const createDirectedRelationAction = 'Crear relación dirigida';
  static const circularRelationError =
      'No se pueden crear vínculos circulares.';
  static const selectElementToRelate = 'Selecciona el elemento por relacionar';
  static const directedRelationCreatedSuccess =
      'Relación dirigida creada correctamente.';
  ...
  static const noOtherRelationCandidates =
  ...
  static const selectDirectedRelationType =
      'Seleccionar tipo de relación dirigida';
  ...
  static const interactiveRelationsGraphTitle =
      'Grafo interactivo de relaciones';
  static const noDirectedRelations = 'No hay relaciones dirigidas registradas.';
  static const noDirectedRelationsRegistered =
      'No hay relaciones dirigidas registradas.';
  ...
  static const noHistoryResults =
      'No se encontraron resultados en el historial.';

  // Notificaciones y recordatorios
  static const notificationsAndRemindersTitle =
      'Notificaciones y recordatorios';
  static const refreshAction = 'Actualizar';
  static const noPendingNotifications = 'No hay notificaciones pendientes.';
  static const allElementsUpToDate =
      'Todos los elementos están al día y los requisitos cubiertos.';
  static const loadNotificationsErrorPrefix =
      'Error al cargar notificaciones: ';
  static const snoozeReminderTitle = 'Posponer recordatorio';
  static const snoozeReminderPrompt =
      'Selecciona la duración para posponer este aviso:';
  ...
  static const cannotDeleteSpeciesWithInstancesError =
  ...
  static const subspeciesSeparatedSuccessPrefix =
      'Subespecie separada en la especie ';
  static const separateSubspeciesErrorPrefix =
      'Error al separar la subespecie: ';
  static const noOtherSpeciesToMoveError =
      'No hay otras especies disponibles para trasladar.';
  static const noOtherSpeciesToMergeError =
      'No hay otras especies disponibles para fusionar.';
  ...
  static const noInstancesToTransferNotice =
      'Esta subespecie no tiene instancias asociadas. Se creará la nueva subespecie sin transferir instancias.';
  ...
  static const presetNamePropertyDescription =
      'Permite asignar un nombre o apodo individual a cada instancia creada.';
  static const instanceNameOptionalLabel = 'Nombre opcional';
  static const instanceNameHint =
      'Ejemplo: Mi objeto favorito o Reloj del abuelo.';
  static const propertyNameNombre = 'Nombre';
  static const enterNameForImageSearchError =
      'Ingresa un nombre para buscar la imagen.';
  ...
  static const webImageAssignedSuccess =
      'Imagen de internet asignada correctamente.';
  ...
  static const backupExportSuccess =
      'Copia de seguridad preparada y compartida.';
  static const backupExportErrorPrefix =
      'Error al exportar la copia de seguridad: ';
  static const confirmRestoreTitle = 'Confirmar restauración';
  static const confirmRestoreWarningMessage =
      'Importar una copia de seguridad reemplazará los datos actuales del mundo. ¿Deseas continuar?';
  static const restoreAllAction = 'Restaurar todo';
  static const backupImportSuccess =
      'Copia de seguridad y archivos multimedia restaurados correctamente.';
  static const backupImportErrorPrefix =
  ...
  static const exportBackupSubtitle =
      'Genera un archivo comprimido con los datos del mundo.';
  static const importBackupTitle = 'Importar copia de seguridad';
  static const importBackupSubtitle =
      'Restaura el mundo a partir de un archivo de copia de seguridad.';
  static const restoringBackupDialogTitle = 'Restaurando copia de seguridad...';
  static const restoringBackupDialogMessage =
      'Por favor, espera. Se están importando los datos y los archivos multimedia.';
  ...
  static const cannotDeleteSubspeciesWithInstancesError =
      'No se puede eliminar una subespecie que tiene instancias registradas en el mundo.';
  static const noSubspeciesWarningTitle = 'Sin subespecies';
  static const noSubspeciesWarningMessage =
      'No se agregaron subespecies a la especie. Se creará automáticamente la subespecie "Genérica". ¿Deseas continuar?';

  // Notificaciones y canales
  static const defaultItemName = 'Elemento';
  static const expiredNotificationMessagePrefix = '"';
  static const expiredNotificationMessageSuffix =
      '" ha caducado, con fecha de vencimiento: ';
  static const expiringSoonNotificationMessagePrefix = '"';
  static const expiringSoonNotificationMessageMiddle = '" caducará en ';
  static const expiringSoonNotificationMessageSuffix =
      ' días, con fecha de vencimiento: ';
  ...
  static const unsatisfiedNeedNotificationMessageSuffix =
      '" para cubrir los requisitos totales, disponibles: ';
  static const notificationChannelName = 'Notificaciones de PWMS';
  static const notificationChannelDescription =
      'Notificaciones de caducidad y requisitos no cubiertos.';

  // Propiedades numismáticas y notas
  static const numismaticSpeciesDescriptionPrefix =
      'Especie para piezas numismáticas de tipo ';
  ...
  static const defaultNonPerishableSubtitle =
      'Por defecto los objetos son no perecederos.';
  ...
  static const invalidOrNotFoundCodeMessageSuffix =
      '" no se encontró en las bases de datos en línea.';
  ...
  static const searchDetailedHint =
      'Buscar por especie, subespecie, marca, ubicación o propiedad...';
  ...
  static const noSubspeciesFound =
      'No se encontraron subespecies coincidentes.';
  ...
  static const emptyContainersSearch =
      'No se encontraron objetos contenedores en el mundo.';
  ...
  static const sqlPresetNonContainedWithContainedSpecies =
      'Elementos no guardados con especie en contenedor';
  static const sqlPresetContainedWithNonContainedSpecies =
      'Elementos guardados con especie fuera de contenedor';
  ...
  static const sqlPresetSubgroupRuleViolation =
      'Entidades no objetuales con marca o código';
  static const sqlPresetExpiredEntities = 'Instancias caducadas';
  static const sqlPresetPerishableMissingExpiration =
      'Perecederos sin fecha de caducidad';
  static const sqlPresetNonPerishableWithExpiration =
      'No perecederos con fecha de caducidad';
  static const sqlPresetAnomalousMagnitudes =
      'Magnitudes menores o iguales a cero';
  static const sqlPresetMissingMandatoryMagnitudes =
      'Magnitudes obligatorias faltantes';

  // Propiedades de entidades
  static const editPropertyTitlePrefix = 'Editar propiedad "';
  static const instanceHasAllPropertiesMessage =
      'Esta instancia ya posee todas las propiedades definidas por la especie.';
  static const addSpeciesPropertyTitle = 'Agregar propiedad de especie';
  static const addPropertyAction = 'Agregar propiedad';
  static const noPropertiesAssignedToInstance =
      'No hay propiedades asignadas a esta instancia.';
  ...
  static String materialPurityTooltip(String pct, double fineness) =>
      'Pureza de $pct%, con ley de $fineness.';
  static String materialAlloyTooltip(String alloy) => 'Composición: $alloy.';
  static String materialBimetallicTooltip(String core, String ring) =>
      'Centro: $core\nAnillo: $ring.';
  static String materialPlatedTooltip(String plating) =>
      'Recubrimiento: $plating.';

  // Gestión de población y caducidad
  static const heterogeneousGroupQuantityError =
      'No se puede modificar la cantidad en grupos heterogéneos.';
  static const heterogeneousGroupQuickAdjustmentError =
      'No se pueden realizar ajustes rápidos en grupos heterogéneos.';
  static const expirationDateForNewInstancePrompt =
      'Fecha de caducidad para la nueva instancia';
  static const expirationDateForNewInstancesPrompt =
      'Fecha de caducidad para las nuevas instancias';
  ...
  static const confirmDeleteGroupMessage =
      '¿Deseas reducir la cantidad a cero y eliminar todas las instancias de este grupo?';
  static const instancesDeletedSuccess = 'Instancias eliminadas correctamente.';
  static const selectExpirationDateForNewInstancesPrompt =
      'Selecciona la fecha de caducidad de las nuevas instancias.';
  static const populationUpdatedSuccessPrefix =
      'Población actualizada correctamente a ';
  ...
  static const heterogeneousGroupAdjustmentMessage =
      'No es posible ajustar la población en grupos heterogéneos. Abre la vista de grupo para gestionar las instancias.';
  ...
  static const noInstancesAvailableInGroup =
      'No hay instancias disponibles en este grupo.';
  ...
  static const deleteInstanceConfirmationMessage =
      '¿Deseas eliminar esta instancia del mundo?';

  // Constantes adicionales de infraestructura y formularios
  static const instancePropertiesAndMagnitudesTitle =
      'Propiedades y magnitudes de la instancia';
  static const rootLocationLabel = 'Mundo';
  static const sqlHelpHint =
      'Escribe una consulta SQL de lectura para inspeccionar la base de datos local.';
  static const sqlNoRowsReturned =
      'La consulta se ejecutó correctamente, pero no devolvió registros.';
  static const sqlSecurityErrorPrefix =
      'Por seguridad, las consultas SQL están restringidas exclusivamente a operaciones de lectura. El comando "';
  static const sqlSecurityErrorSuffix = '" no está permitido.';
  static const sqlSyntaxErrorPrefix =
      'Error de sintaxis o ejecución en la consulta SQL: ';
  static const applyCorrectionAction = 'Aplicar corrección';
  static const applyRecommendedCorrectionQuestion =
      '¿Deseas aplicar la corrección recomendada?';
  static String applyRecommendedCorrectionWithValue(
  ...
  static const movedSuccessfullyInGraphSuffix =
      '" trasladado correctamente en el grafo.';
  static const correctLocationTitlePrefix = 'Corregir ubicación de "';
  static const correctLocationTitleSuffix = '"';
  static const notificationInitErrorPrefix =
      'Error en la inicialización de notificaciones: ';

  // Constantes de interfaz, pantalla principal y herramientas
  static const controlCenterTooltip = 'Centro de control';
  static const settingsTooltip =
      'Configuración de la aplicación y copias de seguridad';
  ...
  static const itemsSavedInContainerSuccess =
      'Elementos guardados en el contenedor correctamente.';
  ...
  static const backupManagementSubtitle =
      'Exporta o restaura la base de datos completa del mundo.';
  static const selectValidContainerPrompt =
      'Selecciona un objeto contenedor válido.';
  static const locationCorrectedSuccess = 'Ubicación corregida correctamente.';
  static const locationCorrectionErrorPrefix =
      'Error al corregir la ubicación: ';
  ...
  static const softwareUpdatesSubtitle =
      'Comprueba si existen nuevas versiones publicadas de PWMS.';
  static const checkForUpdatesTitle = 'Buscar actualizaciones';
  static const checkForUpdatesSubtitle =
      'Verifica si existen nuevas versiones disponibles.';
  static const updateAvailableTitle = 'Actualización disponible';
  static const updateAvailablePrompt =
      'Existe una nueva versión de la aplicación disponible. ¿Deseas descargarla e instalarla ahora?';
  ...
  static const unsupportedPlatformUpdate =
  ...
  static const dataHealthVerifiedSubtitle =
      'No se detectaron anomalías ni inconsistencias en el inventario. El mundo está perfectamente estructurado.';
  ...
  static const attachmentNameRetainedSuccess =
      'Nombre del archivo adjunto mantenido.';
  static const attachmentRenamedSuccess =
      'Archivo adjunto renombrado correctamente.';
  static const emptyGradeDataTitle =
      'Dato numismático vacío: grado de conservación';
  static const gradeRetainedEmptySuccess =
      'Grado de conservación mantenido vacío.';
  static const assignGradeTitle = 'Asignar grado de conservación';
  static const controlCenterLoadErrorPrefix =
      'Error al cargar tarjetas de control: ';
  static const uninstantiatedSubspeciesAuditTitle =
      'Subespecie no instanciada en el mundo';
  static const uninstantiatedSpeciesAuditTitle =
      'Especie no instanciada en el mundo';
  static const locationVerificationAuditTitle =
      'Verificación de ubicación de la instancia';
  ...
  static const incompleteSpeciesInfoAuditTitle =
      'Información de especie incompleta';
  static const remoteImageAuditTitle = 'Imágenes remotas sin descargar';
  static const numismaticSubspeciesIncongruityTitle =
      'Incongruencia en la subespecie numismática';
  static const numismaticDuplicateSubspeciesTitle =
      'Subespecie numismática duplicada';
  static const numismaticAttachmentIncongruityTitle =
      'Incongruencia en el archivo adjunto numismático';
  static const numismaticMissingMagnitudesTitle =
      'Magnitudes numismáticas faltantes';
  static const numismaticEmissionOutlierAuditTitle =
      'Anomalía histórica en emisión numismática';
  ...
  static const uniquenessViolationAuditTitle =
      'Inconsistencia de unicidad en especie';
  static const perishableMissingExpirationAuditTitle =
      'Producto perecedero sin fecha de caducidad';
  static const nonPerishableWithExpirationAuditTitle =
      'Producto no perecedero con fecha de caducidad';
  static const subgroupRuleViolationAuditTitle =
      'Infracción de regla de subgrupo';
  static const missingMandatoryMagnitudesAuditTitle =
      'Magnitudes obligatorias faltantes';
  ...
  static const duplicatePhotoAuditTitle =
      'Fotografía compartida entre especies';
  ...
  static const enterDenominationNumberPrompt =
      'Ingresa el número de denominación.';
  static const enterValidNumericValuePrompt =
  ...
  static const unsavedChangesMessage =
      'Tienes modificaciones pendientes sin guardar. ¿Deseas descartar los cambios o continuar editando?';
  ...
  static const confirmReplaceAttachmentMessage =
      '¿Deseas reemplazar este archivo adjunto? El archivo anterior será sustituido.';
  static const confirmDeleteSubspeciesTitle = 'Eliminar subespecie';
  static const confirmDeleteSubspeciesMessagePrefix =
      '¿Deseas eliminar permanentemente la subespecie "';
  static const confirmDeleteSubspeciesMessageSuffix = '"?';
  static const confirmDeleteRequirementTitle = 'Eliminar requisito';
  static const confirmDeleteRequirementMessagePrefix =
      '¿Deseas eliminar este requisito de "';
  static const confirmDeleteRequirementMessageSuffix = '"?';
  static const confirmDeleteRelationTitle = 'Eliminar relación';
  static const confirmDeleteRelationMessagePrefix =
      '¿Deseas eliminar la relación "';
  ...
  static const confirmDeleteLocationMessagePrefix =
      '¿Deseas eliminar la ubicación "';
  static const confirmDeleteLocationMessageSuffix =
      '" y sus referencias asociadas?';
  static const confirmRemovePhotoTitle = 'Quitar fotografía';
  static const confirmRemovePhotoMessage =
      '¿Deseas eliminar la fotografía seleccionada?';
  static const confirmRemoveAttributeTitle = 'Eliminar atributo';
  static const confirmRemoveAttributeMessagePrefix =
      '¿Deseas eliminar el atributo personalizado "';
  static const confirmRemoveAttributeMessageSuffix = '"?';
  static const confirmDeletePropertyTitle = 'Eliminar propiedad';
  static const confirmDeletePropertyMessagePrefix =
      '¿Deseas eliminar la propiedad "';
  ...
  static String confirmDeleteSelectionPrompt(int count) => count == 1
      ? '¿Deseas eliminar 1 elemento?'
      : '¿Deseas eliminar $count elementos?';
  static String deleteElementsConfirmation(int count) => count == 1
      ? '¿Deseas eliminar 1 elemento seleccionado?'
      : '¿Deseas eliminar $count elementos seleccionados?';
  ...
  static String replaceAttachmentTitle(String name) =>
      'Reemplazar archivo adjunto: $name';
  ...
  static const productOrSpeciesSearchHint =
      'Nombre del producto o de la especie...';
  static const coinObverse = 'Anverso';
  static const coinReverse = 'Reverso';
  static const completeAllFieldsPrompt =
  ...
  static const whatActionForSpeciesPrompt =
      '¿Qué acción deseas realizar con esta especie?';
  static const createInstanceAction = 'Crear instancia';
  static const deleteSpeciesAction = 'Eliminar especie';
  static const relationalLocationConflictTitle =
      'Conflicto de ubicación en contenedor';
  ...
  static const perishableWithoutExpirationTitle =
      'Perecedero sin fecha de caducidad';
  static const nonPerishableWithExpirationTitle =
      'No perecedero con fecha de caducidad';
  static const booleanFalseAction = 'No';
  static const booleanTrueAction = 'Sí';
  static const numismaticIncongruityTitle =
      'Incongruencia en datos numismáticos';
  static const updateSubspeciesFromInstanceAction =
      'Actualizar subespecie según la instancia';
  static const desyncedAttachmentNameTitle =
      'Nombre de archivo adjunto desincronizado';
  static const mergeDuplicateSubspeciesAction =
      'Fusionar subespecies duplicadas';
  ...
  static const uninstantiatedSpeciesWorldTitle =
      'Especie sin instancias en el mundo';
  ...
  static const numismaticDuplicateSubspeciesCardTitle =
      'Subespecies numismáticas duplicadas';
  static const numismaticEmissionOutlierCardTitle =
      'Anomalía histórica numismática';
  static const numismaticEmissionOutlierSkipped =
      'Anomalía histórica mantenida sin cambios.';
  static const numismaticEmissionOutlierFixedSuccess =
      'Anomalía numismática corregida correctamente.';
  ...
  static const correctNumismaticIncongruityTitle =
      'Corregir incongruencia numismática';
  ...
  static const negativeMagnitudeViolationTitle =
      'Valor numérico negativo no válido';
  static const propertyNameSuggestionIncongruityTitle =
      'Nombre de propiedad sugerido';

  static const correctLocationOrContainerAction =
      'Corregir ubicación o contenedor';
  static const selectLocationOrContainerPrompt =
      'Seleccionar ubicación o contenedor';
  ...
  static const subspeciesDuplicationSkipped =
      'Duplicidad de subespecie omitida.';
  static const speciesSetToNotUniqueSuccess =
      'Especie configurada como no única.';
  static const duplicatesDeletedPreservedOneSuccess =
      'Instancias duplicadas eliminadas. Se conservó una instancia.';
  static const attributesSkipped = 'Atributos omitidos.';
  static const brandAndBarcodeRemovedSuccess =
      'Marca y código de barras eliminados correctamente.';
  static const speciesKeptInCatalog = 'Especie conservada en el catálogo.';
  static const speciesDeletedFromCatalogSuccess =
      'Especie eliminada del catálogo.';
  static const informationSkippedForNow = 'Información omitida por el momento.';
  static const remoteImageKeptWithoutDownload =
      'Imagen remota conservada sin descargar.';
  ...
  static const directLocationRemovedKeptInContainerSuccess =
      'Ubicación directa eliminada. Conservado en el contenedor.';
  static const elementRemovedFromContainerSuccess =
      'Elemento retirado del contenedor.';
  static const circularRelationKept = 'Relación circular conservada.';
  static const conflictingRelationDeletedSuccess =
      'Relación en conflicto eliminada.';
  static const instanceConfirmedInInventory =
      'Instancia confirmada en el inventario.';
  static const instanceDeregisteredSuccess =
      'Instancia dada de baja correctamente.';
  static const locationConfirmedSuccess = 'Ubicación confirmada.';
  static const expirationDateSkipped = 'Fecha de caducidad omitida.';
  static const expirationDateUpdatedSuccess =
      'Fecha de caducidad actualizada correctamente.';
  static const expirationDateKept = 'Fecha de caducidad conservada.';
  static const expirationDateRemovedSuccess =
      'Fecha de caducidad eliminada correctamente.';
  static const magnitudeSkipped = 'Magnitud omitida.';
  static const valueKept = 'Valor conservado.';
  static const duplicateSubspeciesKeptWithoutChanges =
      'Subespecies duplicadas conservadas sin cambios.';
  static const duplicateSubspeciesMergedSuccess =
      'Subespecies duplicadas fusionadas correctamente.';
  static const incongruitySkipped = 'Incongruencia omitida.';
  static const subspeciesAndAttachmentsSyncedSuccess =
      'Subespecie y archivos adjuntos sincronizados correctamente.';
  static const remoteImageDownloadedSuccess =
      'Imagen descargada y guardada localmente con éxito.';
  static const remoteImageDownloadFailedMessage =
      'No se pudo descargar automáticamente la imagen. Puedes seleccionarla desde la galería de fotos.';
  static const invalidUnitRetained = 'Símbolo de unidad conservado.';
  static const unitUpdatedSuccess =
      'Unidad de medida actualizada correctamente.';
  static const unitRemovedSuccess = 'Unidad de medida eliminada correctamente.';
  static const integerUnitNormalizedSuccess =
      'Propiedad normalizada a tipo entero correctamente.';
  static const negativeValueCorrectedSuccess =
      'Valor numérico corregido correctamente.';
  static const propertyNameRenamedSuccess =
      'Nombre de propiedad actualizado correctamente.';
  ...
  static const markAsUnknownOrNotApplicable =
      'Marcar como desconocido o no aplicable';
  static const propertyMarkedAsUnknownSuccess =
      'Propiedad marcada como no disponible o desconocida.';
  static const setNullAction = 'Establecer nulo';
  static const enterValueAction = 'Ingresar valor';

  static const confirmDeleteConflictingRelationMessage =
      '¿Deseas eliminar esta relación en conflicto?';

  static String keepSubspeciesPrompt(String name) =>
      '¿Deseas mantener la subespecie "$name" en el catálogo o eliminarla?';
  ...
  static const ccIntegrityEmptySubtitle =
      'No se encontraron infracciones de reglas ni inconsistencias en el catálogo o inventario.';
  static const ccRoutineEmptyTitle = 'Verificaciones rutinarias al día';
  static const ccRoutineEmptySubtitle =
      'Todas las comprobaciones periódicas de inventario y ubicación han sido completadas.';
  static const ccIgnoredEmptyTitle = 'Sin comprobaciones omitidas';
  static const ccIgnoredEmptySubtitle =
      'Las comprobaciones que marques como no volver a mostrar aparecerán aquí.';
  ...
  static const cardMarkedAsIgnoredSuccess =
      'Marcada para no volver a mostrarse. Puedes encontrarla en la pestaña de comprobaciones omitidas.';
  static const cardUnignoredSuccess =
      'Comprobación reactivada y devuelta a la lista activa.';
  static String pendingIntegrityRules(int count) =>
      count == 1 ? '1 regla pendiente' : '$count reglas pendientes';
  static String pendingRoutineChecks(int count) => count == 1
      ? '1 verificación pendiente'
      : '$count verificaciones pendientes';
  ...
  static String resolveMissingPropertyPrompt(String prop) =>
      '¿Cómo deseas registrar la propiedad "$prop"?';
  static String assignBooleanPrompt(String prop) =>
      'Selecciona el valor booleano para "$prop":';
  static String correctPropertyTitle(String prop) => 'Corregir $prop';
  static String syncInfoPrompt(String name, String msg) =>
      'Sincronizar información para "$name":\n\n$msg';

  static String subspeciesNameWithBrand(String name, String? brand) =>
      brand != null && brand.isNotEmpty ? '$name ($brand)' : name;
  static String uninstantiatedSubspeciesSubtitle(
          String subName, String speciesName) =>
  ...
  static String uniqueSubspeciesDuplicatedSubtitle(
          String subspecies, String species, int count) =>
      '$subspecies • $species: $count instancias';
  static String uniqueSubspeciesDuplicatedQuestion(
          String subspecies, String species, int count) =>
      '¿Deseas eliminar las instancias duplicadas o permitir múltiples instancias de "$subspecies"?';
  static String resolveUniquenessPrompt(
          String subspecies, String species, int count) =>
  ...
  static String remoteSubspeciesImageSubtitle(
          String subspecies, String species) =>
      '$subspecies • $species';
  ...
  static String perishableMissingExpirationSubtitle(
          String displayName, String species) =>
      '$displayName • Especie: $species';
  static String perishableMissingExpirationQuestion(
          String species, String displayName) =>
      '¿Deseas asignar fecha de caducidad a la instancia "$displayName" de especie $species?';
  static String nonPerishableWithExpirationSubtitle(
          String displayName, String date) =>
      '$displayName • Caducidad asignada: $date';
  static String nonPerishableWithExpirationQuestion(
          String species, String displayName) =>
  ...
  static String missingMagnitudeTitle(String property) =>
      'Magnitud faltante: $property';
  static String missingMagnitudeSubtitle(
          String displayName, String property, String unitSuffix) =>
      '$displayName • La especie define $property$unitSuffix';
  static String missingMagnitudeQuestion(
          String displayName, String property, String species) =>
  ...
  static String anomalousMagnitudeSubtitle(
          String displayName, String property, num value, String unit) =>
      unit.isNotEmpty
          ? '$displayName • $property: $value $unit'
  ...
  static String numismaticDuplicateSubspeciesSubtitle(
          String subspecies, int count, String species) =>
      '$subspecies • $count subespecies idénticas en $species';
  static String numismaticDuplicateSubspeciesQuestion(
          int count, String subspecies) =>
  ...
  static String numismaticSubspeciesIncongruitySubtitle(
          String displayName, String subspecies) =>
  ...
  static String desyncedAttachmentNameSubtitle(
          String displayName, String fileName) =>
      '$displayName • Archivo actual: $fileName';
  static String desyncedAttachmentNameQuestion(
          String fileName, String subspecies, String expected) =>
  ...
  static String numismaticEmissionOutlierSubtitle(
          String displayName, String anomalyDescription) =>
      '$displayName • $anomalyDescription';
  static String numismaticEmissionOutlierQuestion(
          String anomalyDetail, String suggestedFix) =>
  ...
  static String numismaticCurrencyAnachronismDesc(
          String foundIso, String expectedIso, int year, String country) =>
      'Divisa $foundIso no válida para $country en $year. Divisa esperada: $expectedIso.';
  static String numismaticMaterialContradictionDesc(
          String foundMat, String expectedMat, String denom) =>
  ...
  static String numismaticDenominationAnomalyDesc(
          String denom, String country, int year) =>
  ...
  static String invalidUnitSymbolSubtitle(
          String targetName, String propName, String symbol) =>
  ...
  static String integerUnitIncongruitySubtitle(
          String targetName, String propName, String symbol) =>
      '$targetName • Propiedad "$propName" con unidad "$symbol" con tipo o valor no entero';
  static String integerUnitIncongruityQuestion(
          String propName, String symbol) =>
      '¿Deseas normalizar a número entero el valor y tipo de "$propName" con unidad "$symbol"?';
  static String nonNumericWithUnitSubtitle(
          String targetName, String propName, String dataType, String symbol) =>
  ...
  static String negativeMagnitudeViolationSubtitle(
          String targetName, String propName, num val, String symbol) =>
      symbol.isNotEmpty
  ...
  static String propertyNameSuggestionIncongruitySubtitle(String spName,
          String currentProp, String suggestedProp, String symbol) =>
      '$spName • "$currentProp" con unidad "$symbol" ➔ Sugerido: "$suggestedProp"';
  static String propertyNameSuggestionIncongruityQuestion(
          String currentProp, String suggestedProp, String symbol) =>
  ...
  static const capturingHighDefinitionPrompt =
      'Capturando en alta resolución...';
  ...
  static const bothSidesReadyTip =
      'Ambos lados listos. Pulsa Continuar a datos numismáticos.';
  static const cameraIlluminationTip =
      'Consejo: Activa la linterna y ajusta el zoom para encuadrar la pieza.';
  static const continueToNumismaticDataAction =
      'Continuar a datos numismáticos';
  static const emptyContainerPrompt =
  ...
  static String currencyCodeWithName(String code, String name) =>
      '$code ($name)';
  ...
  static const attachmentAddedToEditing =
      'Archivo adjunto agregado a la edición.';
  static const attachmentAddedSuccessfully =
      'Archivo adjunto agregado correctamente.';
  static const numismaticAttachmentModifiedInEditing =
      'Archivo adjunto numismático modificado en la edición.';
  static const numismaticAttachmentUpdatedSuccessfully =
      'Archivo adjunto numismático actualizado correctamente.';
  static const attachmentModifiedInEditing =
      'Archivo adjunto modificado en la edición.';
  static const attachmentReplacedSuccessfully =
      'Archivo adjunto reemplazado correctamente.';
  ...
  static const physicalFileNotFoundInStorage =
      'El archivo físico no existe en el almacenamiento.';
  static const attachmentRemovedFromEditing =
      'Archivo adjunto eliminado de la edición.';
  static const attachmentDeletedSuccessfully =
  ...
  static const addAttachmentToThisInstance =
      'Agregar archivo adjunto a esta instancia';
  static const physicalFileNotFound = 'Archivo físico no encontrado';
  static const selectOrCaptureAttachmentTitle =
      'Seleccionar o capturar archivo adjunto';
  ...
  static const searchOnlineImagesByName =
      'Buscar imágenes en internet por nombre';
  ...
  static const noBarcodeOrIsbnDetected =
      'No se detectó un código de barras o ISBN en la imagen.';
  ...
  static String confirmDeleteAttachmentPrompt(String name) =>
      '¿Deseas eliminar permanentemente el archivo "$name"?';
  ...
  static String instancesToTransferTitle(int selected, int total) =>
      'Instancias a transferir: $selected de $total';
  ...
  static String suggestedSearchQuery(String query) =>
      'Búsqueda sugerida: "$query"';
  static String searchingBarcode(String barcode) =>
  ...
  static String photoProcessingError(String err) =>
      'Error al procesar fotografía: $err.';
  static String searchWebImagesError(String err) =>
      'Error al buscar imágenes en internet: $err.';
  static String downloadOrAssignImageError(String err) =>
      'Error al descargar o asignar la imagen: $err.';
  static String saveSubspeciesError(String err) =>
      'Error al guardar la subespecie: $err.';
  static String replaceAttachmentError(String err) =>
      'Error al reemplazar el archivo adjunto: $err.';
  ...
  static String mergeSpeciesError(String err) =>
      'Error al unir especies: $err.';

  // Respaldo y base de datos
  static const backupZipCompressionError =
      'Error al generar la compresión del paquete de copia de seguridad.';
  static const backupZipMissingDatabaseJsonError =
      'El archivo comprimido de respaldo no contiene una base de datos válida.';
  static const invalidBackupStructureError =
      'El archivo de copia de seguridad no tiene una estructura válida.';
  static const unspecifiedGrade = 'No especificado';

  // Servicio de actualizaciones
  static const errorGettingPackageVersion =
      'Error al obtener la versión del paquete.';
  static const checkingUpdateInNativeChannel =
      'Consultando la disponibilidad de actualizaciones...';
  static const platformExceptionCheckingUpdate =
      'Error del sistema al verificar la actualización.';
  static const unexpectedErrorCheckingUpdate =
      'Error inesperado al verificar la actualización.';
  static const invokingUpdateAppNative =
      'Iniciando el proceso de actualización...';
  static const errorExecutingUpdateApp =
      'Error al ejecutar la actualización de la aplicación.';
  static const errorTriggeringUpdate = 'Error al iniciar la actualización.';

  // Helpers dinámicos
  static String sourceFileNotFoundAtPath(String path) =>
      'El archivo de origen no existe en la ruta: $path.';
  ...
  static String updateCheckResult(
          bool available, String? latest, String current) =>
      available
  ...
  static String sqlSecurityError(String kw) =>
      '$sqlSecurityErrorPrefix$kw$sqlSecurityErrorSuffix';
  ...
  static String noSearchMatches(String query) =>
      '$noSearchMatchesPrefix$query$noSearchMatchesSuffix';
  ...
  static String backupExportErrorMessage(Object error) =>
      '$backupExportErrorPrefix$error';
  static String backupImportErrorMessage(Object error) =>
      '$backupImportErrorPrefix$error';
  static String formatObjectsCount(int count) =>
      count == 1 ? '1 $objectsLabel' : '$count $objectsLabel';
  static String sectionHeaderWithCount(String section, int count) =>
      '$section: $count';
  ...
  static const historyScreenSubtitle =
      'Consulta todos los cambios y eventos registrados en la base de datos.';
  ...
  static const historyEmptySearch =
      'No se encontraron eventos que coincidan con la búsqueda.';
  static const historyEmptyCategory =
      'No hay actividad registrada en esta categoría.';
  static const noHistoryEvents = 'Sin actividad registrada';
  static const noHistoryEventsSubtitle =
      'Los eventos y modificaciones en el sistema aparecerán aquí cronológicamente.';
  ...
  static const historyClearConfirmationTitle =
      '¿Vaciar historial de actividad?';
  static const clearHistoryTitle = '¿Vaciar historial de actividad?';
  static const historyClearConfirmationMessage =
      'Esta acción eliminará los registros del historial de eventos. Los datos de tus instancias, especies y ubicaciones no se verán afectados.';
  static const clearHistoryConfirmation =
      'Esta acción eliminará los registros del historial de eventos. Los datos de tus instancias, especies y ubicaciones no se verán afectados.';
  static const cancelAction = 'Cancelar';
  static const clearAction = 'Vaciar';
  static const historyAuditLogSettings =
      'Historial de auditoría de la base de datos';
  static const historyAuditLogSettingsSubtitle =
      'Consulta todos los cambios y eventos registrados en la base de datos.';
  static const timeJustNow = 'Hace un momento';
  static String timeMinutesAgo(int m) =>
  ...
  static String activityRegistered(String name, String type) =>
      'Registrado en el mundo: "$name", tipo $type.';
  static String activityEditedWithDetails(String name, String details) =>
      'Editado "$name": $details.';
  static String activityEdited(String name) =>
      'Información editada de "$name".';
  static String activityDeleted(String name) => 'Eliminado del mundo: "$name".';
  static String activityMoved(String name, String from, String to) =>
      'Trasladado "$name" de "$from" a "$to".';
  static String activityAttachmentAdded(String fileName, String entityName) =>
      'Archivo "$fileName" adjuntado a "$entityName".';
  static String activityAttachmentRemoved(String fileName, String entityName) =>
      'Archivo "$fileName" eliminado de "$entityName".';
  static String activityRelationAdded(
          String sourceName, String relationType, String targetName) =>
      'Vínculo establecido: "$sourceName" con relación $relationType hacia "$targetName".';
  static String activityRelationRemoved(
          String sourceName, String relationType, String targetName) =>
      'Vínculo eliminado: "$sourceName" con relación $relationType hacia "$targetName".';
  static String activityPhotoChanged(String name) =>
      'Fotografía principal actualizada de "$name".';
  static String activityPhotoRemoved(String name) =>
      'Fotografía principal eliminada de "$name".';
  static String activityQuantityConsumed(
          String name, Object qty, String unit) =>
      'Cantidad ajustada de "$name": $qty $unit.';
  static String activitySpeciesCreated(String name, String type) =>
      'Nueva especie registrada: "$name", tipo $type.';
  static String activitySpeciesEdited(String name, String details) =>
      'Especie modificada "$name": $details.';
  static String activitySpeciesDeleted(String name) =>
      'Especie eliminada: "$name".';
  static String activitySpeciesMerged(String source, String target) =>
      'Especie "$source" fusionada en "$target".';
  static String activitySubspeciesCreated(String subName, String speciesName) =>
      'Nueva subespecie registrada: "$subName" en "$speciesName".';
  static String activitySubspeciesSeparated(
          String subName, String newSpecies) =>
      'Subespecie "$subName" separada a especie "$newSpecies".';
  static String activitySubspeciesMoved(String subName, String targetSpecies) =>
      'Subespecie "$subName" trasladada a "$targetSpecies".';
  static String activitySubspeciesDeleted(String subName) =>
      'Subespecie eliminada: "$subName".';
  static String activitySubspeciesSplit(
          String origName, String newName, int count) =>
      'Subespecie "$origName" dividida en "$newName", con $count instancias transferidas.';
  static String activityLocationCreated(String name) =>
      'Nueva ubicación registrada: "$name".';
  static String activityLocationEdited(String name) =>
      'Ubicación modificada: "$name".';
  static String activityLocationMoved(String name, String? parent) =>
      parent != null
          ? 'Ubicación "$name" trasladada a "$parent".'
          : 'Ubicación "$name" convertida en principal.';
  static String activityLocationDeleted(String name) =>
      'Ubicación eliminada: "$name".';
  static String activityEntitiesBatchDeleted(int count) => count == 1
      ? 'Eliminación en lote: 1 instancia eliminada.'
      : 'Eliminación en lote: $count instancias eliminadas.';
  static String activityBackupExported(int totalRecords) =>
      'Copia de seguridad exportada con $totalRecords registros.';
  static String activityBackupRestored(int totalRecords, String? originDate) =>
      originDate != null
          ? 'Copia de seguridad restaurada con $totalRecords registros, fecha de origen: $originDate.'
          : 'Copia de seguridad restaurada con $totalRecords registros.';
  static String activityAuditFixApplied(String ruleTitle, String details) =>
      'Auditoría aplicada: $ruleTitle. $details.';
  static String activityEntityUpdatedInPlace(String name, String changes) =>
      'Instancia actualizada de "$name": $changes.';

  // Helpers de presentación
  static String editPropertyTitle(String propertyName) =>
      'Editar propiedad "$propertyName"';
  ...
  static String propertyWithUnitOrType(
          String propertyName, String unitOrType) =>
      '$propertyName - $unitOrType';
  static String deleteSpeciesInstanceConfirmation(String speciesName) =>
      '¿Deseas eliminar "$speciesName"?';
  static String speciesGeneralWithType(String speciesName, String type) =>
      'Especie general: $speciesName - $type';
  static String barcodeWithColon(String barcode) =>
      'Código de barras: $barcode';
  static String dateFormattedWithDays(String dateStr, String daysStr) =>
      '$dateStr, $daysStr';
  static String expiredDaysAgo(int days) =>
      days == 1 ? 'Vencido hace 1 día' : 'Vencido hace $days días';
  static String expiresInDaysAlert(int days) =>
      days == 1 ? 'Vence en 1 día' : 'Vence en $days días';
  static String expiresInDays(int days) =>
      days == 1 ? 'Vence en 1 día' : 'Vence en $days días';
  static String confirmDeleteProperty(String propertyName) =>
      '¿Deseas eliminar la propiedad "$propertyName"?';
  static String numismaticSpeciesDescription(String speciesType) =>
      'Colección numismática de $speciesType';
  static String pieceInstantiatedDirectly(String name) =>
      'Pieza "$name" instanciada directamente.';
  static String speciesInstantiatedSuccessWithName(String speciesName) =>
      'Instancia agregada exitosamente: "$speciesName".';
  static String instantiateSpeciesTitle(String speciesName) =>
      'Instanciar "$speciesName"';
  static String subspeciesWithBrand(String name, String? brand) =>
      brand != null && brand.isNotEmpty ? '$name ($brand)' : name;
  static String typeWithPropertyAndValue(
          String type, String propertyName, String displayValue) =>
      '$type • $propertyName: $displayValue';
  static String confirmReplaceAttachmentNamedMessage(String fileName) =>
      '$confirmReplaceAttachmentMessage\n"$fileName"';
  static String confirmReplaceAttachmentRenamedMessage(
          String oldName, String newName) =>
      '$confirmReplaceAttachmentMessage\n"$oldName" ➔ "$newName"';
  static String confirmRemoveAttributeMessage(String key) =>
      '¿Deseas eliminar el atributo "$key"?';
  static String confirmDeleteLocationMessage(String name) =>
      '¿Deseas eliminar la ubicación "$name" y todo su contenido?';
  static String objectsInLocationAndSublocations(int count) =>
      count == 1 ? '1 objeto contenido' : '$count objetos contenidos';
  static String locationCorrectionError(String err) =>
      'Error al corregir la ubicación: $err.';
  static String correctLocationTitle(String entityName) =>
      'Corregir ubicación de "$entityName"';
  static String moveSelectedCountTitle(int count) => count == 1
      ? 'Trasladar 1 elemento seleccionado'
      : 'Trasladar $count elementos seleccionados';
  ...
  static String numismaticEstimatedFineContent(
          String fineWeight, String metalName, String purityPct) =>
  ...
  static const perishabilityReasonNonObjectType =
      'Las especies de tipo distinto a Objeto son no perecederas por definición.';
  static String perishabilityReasonDurableObject(String kw) =>
      'Detectado como objeto duradero o no alimenticio: $kw.';
  static const perishabilityReasonDairy =
      'Categoría lácteos, con aproximadamente 14 días de vida útil.';
  static const perishabilityReasonBakery =
      'Categoría panadería, con aproximadamente 7 días de vida útil.';
  static const perishabilityReasonFruitVeg =
      'Categoría frutas y verduras, con aproximadamente 7 días de vida útil.';
  static const perishabilityReasonMeat =
      'Categoría carnes y pescados, con aproximadamente 5 días de vida útil.';
  static const perishabilityReasonBeverage =
      'Categoría bebidas perecederas, con aproximadamente 30 días de vida útil.';
  static const perishabilityReasonPharmacy =
      'Categoría farmacia y salud, con aproximadamente 365 días de vida útil.';
  static const perishabilityReasonCanned =
      'Categoría enlatados y conservas, con aproximadamente 365 días de vida útil.';
  static const perishabilityReasonDefault =
      'No se identificó una categoría perecedera; configurado como no perecedero por defecto.';

  // Métodos de registro de actividad para entidades
  static String activityEntityCreated(String name, String type) =>
      'Registrado en el mundo: "$name", tipo $type.';
  static String activityEntityEditedWithDetails(String name, String details) =>
      'Editado "$name": $details.';
  static String activityEntityEdited(String name) =>
      'Información editada de "$name".';
  static String activityEntityDeleted(String name) =>
      'Eliminado del mundo: "$name".';
  static String activityEntityMoved(String name, String from, String to) =>
      'Trasladado "$name" de "$from" a "$to".';
  ...
  static String notifMessageExpiringSoon(int daysLeft, String formattedDate) =>
      daysLeft == 1
          ? 'Caduca en 1 día, fecha: $formattedDate.'
          : 'Caduca en $daysLeft días, fecha: $formattedDate.';
  static String notifMessageUnsatisfiedNeed(
          String deficitStr, double stockCount, double requiredQty) =>
  ...
  static String numisCaptureCoinTitle(String side) =>
      'Captura de moneda: $side';
  static String numisCaptureBanknoteTitle(String side) =>
      'Captura de billete: $side';
  ...
  static String numisErrorInitCameraMsg(Object e) =>
      'Error al inicializar la cámara: $e.';
  static const numisCropFailedLogPrefix =
      'El recorte de la imagen falló o excedió el tiempo: ';
  static String numisCropFailedLog(Object e) =>
      'El recorte de la imagen falló o excedió el tiempo: $e.';
  static const numisErrorCapture = 'Error en la captura: ';
  static String numisErrorCaptureMsg(Object e) => 'Error en la captura: $e.';
  static const numisCameraIlluminationTip2 =
      'Consejo: Activa la linterna y ajusta el zoom para encuadrar los relieves.';
  static const numisVolumeShutterTip =
      'Dispara con el obturador o con los botones de volumen.';
  ...
  static String numisAuditCurrencyMismatch(
          String instCurrency, String subCurrency) =>
  ...
  static String numisAuditIncongruence(String joined) =>
      'Incongruencia: $joined.';
  ...
  static String fileAttachedToSpecies(String fileName) =>
      'Archivo "$fileName" adjuntado a la especie.';
  static String confirmDeletePropertyNamed(String propertyName) =>
      '¿Deseas eliminar la propiedad "$propertyName"?';
  static String confirmDeleteSubspeciesNamed(String subspeciesName) =>
      '¿Deseas eliminar permanentemente la subespecie "$subspeciesName"?';
  static String subspeciesOrBrandsWithCount(int count) =>
      count == 1 ? '$subspeciesOrBrands: 1' : '$subspeciesOrBrands: $count';
  static String instancesCount(int count) =>
      count == 1 ? '1 instancia' : '$count instancias';
  static String subspeciesCountWithInstances(
          int subspeciesCount, int instancesCount) =>
      '$subspeciesOrBrands: $subspeciesCount • $tabEntities: $instancesCount';
  static String confirmDeleteSpeciesNamed(String name) =>
      '$deleteConfirmationMessage "$name"?';

  // Helpers de catálogo
  static const propMonetaryUnit = 'Unidad Monetaria';
  static String separatedFromSpeciesName(String name) =>
      '$separatedFromSpeciesPrefix$name';
  static const errorNoCamerasFound =
      'No se encontraron cámaras disponibles en el dispositivo.';
  static const errorCameraInitCancelledWidgetDisposed =
      'Inicialización cancelada debido al cierre de la vista.';
  static const errorCouldNotInitBackCamera =
      'No se pudo inicializar la cámara trasera.';
  static String invalidOrNotFoundCodeMessage(String barcode) =>
      '$invalidOrNotFoundCodeMessagePrefix$barcode$invalidOrNotFoundCodeMessageSuffix';
  ...
  static String confirmDeleteRequirementMessage(String speciesName) =>
      '$confirmDeleteRequirementMessagePrefix$speciesName$confirmDeleteRequirementMessageSuffix';
  static String requirementSummary(String formattedQty, String speciesName) =>
      '$needsPrefix $formattedQty de $speciesName';
  static String formatQuantityValue(double qty) =>
      qty % 1 == 0 ? '${qty.toInt()}' : '$qty';
  static String entitiesTabWithCount(int count) => '$tabEntities: $count';
  static String quantityWithFormattedUnit(String formattedValue, String unit) =>
      '$quantityLabel: $formattedValue $unit';
  static String quantityWithValue(String value) => '$quantityLabel: $value';
  static String breadcrumbPathAndTarget(
          String ancestorPath, String targetName) =>
      '$ancestorPath $targetName';

  // Helpers de presentación e interacción
  static String reviewCounter(int current, int total) =>
      'Revisión $current de $total';
  static String pendingReviews(int count) =>
      count == 1 ? '1 pendiente' : '$count pendientes';
  static String controlCenterLoadError(Object error) =>
      '$controlCenterLoadErrorPrefix$error';
  static String countString(num count) => count.toString();
  static String speciesTypeWithBullet(String type, String? name) =>
      name != null && name.isNotEmpty ? '$type • $name' : type;
  static String objectsCount(int count) =>
      count == 1 ? '1 $objectsLabel' : '$count $objectsLabel';
  static const draggingElement = 'Arrastrando elemento';
  static String draggingUnits(int count) =>
      count == 1 ? 'Arrastrando 1 unidad' : 'Arrastrando $count unidades';
  static String draggingSelectedElements(int count) => count == 1
      ? 'Arrastrando 1 elemento seleccionado'
      : 'Arrastrando $count elementos seleccionados';
  static String updateErrorWithDetails(Object err) => '$updateError$err';
  static String appVersionDisplay(String version) =>
      '$appName • $appVersionLabel: v$version';
  static String loadNotificationsError(Object err) =>
      '$loadNotificationsErrorPrefix$err';
  static String saveRelationError(Object err) => '$saveRelationErrorPrefix$err';
  static String quoted(String text) => '"$text"';
  static String relationCreatedSuccess(String relationType) =>
      '$relationCreatedSuccessPrefix$relationType$relationCreatedSuccessSuffix';
  static String linkEntityTitle(String name) => '$link "$name"';
  static String relationsLoadError(Object err) =>
      '$relationsLoadErrorPrefix$err';
  static String linksCount(int count) => '$count$linksCountSuffix';
  static String confirmDeleteRelationMessage(
          String relationType, String otherName) =>
  ...
  // Operaciones de taxonomía
  static String subspeciesSeparatedSuccess(String speciesName) =>
      '$subspeciesSeparatedSuccessPrefix"$speciesName".';
  static String separateSubspeciesError(Object e) =>
      '$separateSubspeciesErrorPrefix$e';
  static String subspeciesMovedSuccess(String targetName) =>
      '$subspeciesMovedSuccessPrefix"$targetName".';
  ...
  static String splitSubspeciesError(Object e) =>
      '$splitSubspeciesErrorPrefix$e';

  // Visualización de entidades
  static String speciesWithSubspeciesDisplay(
          String speciesName, String subspeciesWithBrand) =>
      '$speciesName - $subspeciesWithBrand';
  static const affirmativeYes = 'Sí';
  static const negativeNo = 'No';
  static String valueWithUnit(String value, String unit) => '$value $unit';
  static String propertyNameWithUnitText(String name, String unitText) =>
      '$name$unitText';

  // Previsualización de instancias
  static String speciesTypeWithSpeciesNamePrefix(
          String type, String speciesName) =>
      '$type • $speciesName • ';
  static String speciesTypeBulletPrefix(String type) => '$type • ';
  static String propertyWithColon(String propertyName, String displayValue) =>
  ...
  // Adjuntos
  static String scanReverseFileName(String speciesName) =>
      '${scanReverseTitle}_$speciesName${AppTechnicalStrings.extJpg}';

  // Gobernanza y confirmaciones inmediatas
  static const duplicateSpeciesDialogTitle = 'Nombre de especie duplicado';
  static String duplicateSpeciesPrompt(String name) =>
      'Ya existe una especie registrada con el nombre "$name". ¿Qué acción deseas realizar?';
  ...
  static String duplicatePhotoPrompt(String speciesName) =>
      'Esta imagen ya está asignada a la especie "$speciesName". ¿Deseas vincular la misma fotografía o elegir otra?';
  static const reusePhotoAction = 'Vincular la misma foto';
  static const deleteSpeciesWithInstancesTitle =
      'Eliminar especie con instancias';
  static String deleteSpeciesWithInstancesPrompt(
          String speciesName, int count) =>
      count == 1
  ...
  static const deleteSubspeciesWithInstancesTitle =
      'Eliminar subespecie con instancias';
  static String deleteSubspeciesWithInstancesPrompt(
          String subName, int count) =>
      count == 1
  ...
  static const nonStandardFieldsHint =
      'Campos no habituales para este subgrupo que se guardarán como excepción.';
  ...
  static String speciesDeletedWithCascadeSuccess(int count) => count == 1
  ...
  static const selectTargetSubspeciesPrompt =
      'Selecciona la subespecie de destino:';
  static const selectTargetSpeciesPrompt = 'Selecciona la especie de destino:';
  static const duplicateSpeciesMergedSuccess =
      'Especies homónimas fusionadas correctamente.';
  static const speciesRenamedSuccess = 'Especie renombrada correctamente.';
  static const photoDecoupledSuccess =
      'Fotografía desacoplada para esta especie.';
  static const genericSubspeciesGeneratedSuccess =
      'Subespecie "Genérica" generada correctamente.';
  static const instanceReassignedSuccess =
      'Instancia reasignada correctamente.';
  ...
  static const expirationsEmptySubtitle =
      'Las instancias con fecha de caducidad aparecerán aquí.';
  ...
  static const instanceConsumedSuccess =
      'Instancia consumida y registrada en el historial.';
  ...
  static const noExpirationsForDate =
      'No hay vencimientos registrados para este día.';
  ...
  static String streakDaysCount(int count) =>
      count == 1 ? '1 día' : '$count días';
  static String totalEventsThisMonth(int count) =>
      count == 1 ? '1 acción este mes' : '$count acciones este mes';
  static String totalEventsInYear(int count) =>
      count == 1 ? '1 acción en el año' : '$count acciones en el año';
  static const heatmapLess = 'Menos';
  static const heatmapMore = 'Más';
  static String heatmapActivityCount(int count, String date) =>
      count == 1 ? '1 acción el $date' : '$count acciones el $date';
  ...
  static String shelfLifeRemaining(int days) =>
  ...
  static String consumedEventDescription(String name) =>
      'Se consumió la instancia "$name".';
  ...
  static String dateWithRelativeTime(String dateStr, String relativeStr) =>
      '$dateStr, $relativeStr';
  ...
  static String heatmapHeaderStats(int streak, int total) =>
      '🔥 ${streakDaysCount(streak)} de racha · $total acciones en el año';
  static const weekdayShortLetters = ['L', 'M', 'X', 'J', 'V', 'S', 'D'];
  static const weekdayShortLettersSundayFirst = [
    'D',
    'L',
    'M',
    'X',
